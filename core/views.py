...
def predict_view(request):
    ...
    if request.method == 'POST':
        try:
            ...
            # نتیجه متن.
            result_text = [
                f'ریسک نا موفق بودن رابطه شما : {prob:.2f}%',
            ...
            # نمودار Plotly.
            fig = px.pie(names=['موفقیت', 'ناموفق'], values=[100 - prob, prob], title='ریسک روابط زوج‌ها', color_discrete_map={'موفقیت': 'green', 'ناموفق': 'red'})
